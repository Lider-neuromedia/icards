<div id="allowed-accounts-data" data-accounts='@json($accounts)' data-allowed='@json(old('allowed_accounts') ?: $allowedAccounts)'>
    <div class="row" id="allowed-accounts-app">
        <div class="col-12 col-md-6">
            ...
            <input v-for="account in enabledAccounts" :key="account.id" type="hidden" name="allowed_accounts[]"
                :value="account.id" />
            ...
            <div class="list-group">
                <button v-for="account in enabledAccounts" :key="account.id" type="button"
                    style="line-height: 1.1rem;" class="list-group-item list-group-item-action"
        ...
        <div class="col-12 col-md-6">
            ...
            <div class="overflow-auto" style="max-height: 350px;">
                <div class="list-group">
                    <button v-for="account in disabledAccounts" :key="account.id" type="button"
                        style="line-height: 1.1rem;" class="list-group-item list-group-item-action"
